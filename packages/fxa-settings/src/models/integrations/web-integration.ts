...
export class BaseIntegrationData extends ModelDataProvider {
  ...
  @IsOptional()
  // TODO: change this to 'IsEmail'. Requiring this to be an email causes
  // this to throw when we have a separate model, like a query param or link
  // model for a page, where we validate this instead.
  @IsString()
  @bind()
